...
function Producto() {
    ...
    const productosRecomendados = productos.slice(6,10).filter(data => data.id != id);
  return (
    <Container>
      <Row>
        <Col>
      ...
      <Row className="p-3 border-bottom">
          <Col lg={6}>
              <div className="card no-borders">
                  <div className="card-img">
                      <img className="d-block mx-auto" src={photo} style={{maxWidth:400}} alt="e-commerce"/>
                  </div>
              </div>
          </Col>
          <Col>
          <div className="card no-borders">
              <div className="card-body">
                  ...
                  <p>&#36;{dataProducto.precio}
                  <br/>
                  <b>Cod de Producto:</b> {dataProducto.referencia}</p>
                  </Col>
                  </Row>
                  <Row className="mb-2">
                      <Col>
                  ...
                  <Row className="mb-2">
                      ...
                      {tallas.map((data, index)=>{
                        return(
                            <button type="button" key={index} className="btn btn-secondary tallasitems btn-xs m-1">
                                {data}
                            </button>
                        )
                    })}
